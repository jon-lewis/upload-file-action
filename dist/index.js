...
module.exports = __nccwpck_require__(9147);
...
var utils = __nccwpck_require__(2145);
var settle = __nccwpck_require__(6204);
var buildURL = __nccwpck_require__(1871);
var http = __nccwpck_require__(3685);
var https = __nccwpck_require__(5687);
var httpFollow = (__nccwpck_require__(849).http);
var httpsFollow = (__nccwpck_require__(849).https);
var url = __nccwpck_require__(7310);
var zlib = __nccwpck_require__(9796);
var pkg = __nccwpck_require__(8593);
var createError = __nccwpck_require__(5843);
var enhanceError = __nccwpck_require__(4087);
...
var settle = __nccwpck_require__(6204);
var buildURL = __nccwpck_require__(1871);
var parseHeaders = __nccwpck_require__(4100);
var isURLSameOrigin = __nccwpck_require__(2464);
var createError = __nccwpck_require__(5843);
...
module.exports = function xhrAdapter(config) {
  return new Promise(function dispatchXhrRequest(resolve, reject) {
    ...
    if (utils.isStandardBrowserEnv()) {
      var cookies = __nccwpck_require__(1615);
...
var utils = __nccwpck_require__(2145);
var bind = __nccwpck_require__(9499);
var Axios = __nccwpck_require__(6484);
var mergeConfig = __nccwpck_require__(2734);
var defaults = __nccwpck_require__(9035);
...
axios.Cancel = __nccwpck_require__(7600);
axios.CancelToken = __nccwpck_require__(7860);
axios.isCancel = __nccwpck_require__(6625);

// Expose all/spread
axios.all = function all(promises) {
  return Promise.all(promises);
};
axios.spread = __nccwpck_require__(9968);
...
var Cancel = __nccwpck_require__(7600);
...
var utils = __nccwpck_require__(2145);
var buildURL = __nccwpck_require__(1871);
var InterceptorManager = __nccwpck_require__(1109);
var dispatchRequest = __nccwpck_require__(7165);
var mergeConfig = __nccwpck_require__(2734);
...
var utils = __nccwpck_require__(2145);
var transformData = __nccwpck_require__(5819);
var isCancel = __nccwpck_require__(6625);
var defaults = __nccwpck_require__(9035);
var isAbsoluteURL = __nccwpck_require__(8176);
var combineURLs = __nccwpck_require__(3399);
...
var utils = __nccwpck_require__(2145);
var normalizeHeaderName = __nccwpck_require__(5113);
...
function getDefaultAdapter() {
  ...
  if (typeof process !== 'undefined' && Object.prototype.toString.call(process) === '[object process]') {
    ...
    adapter = __nccwpck_require__(6927);
  } else if (typeof XMLHttpRequest !== 'undefined') {
    // For browsers use XHR adapter
    adapter = __nccwpck_require__(6028);
  }
  return adapter;
}
...
var bind = __nccwpck_require__(9499);
var isBuffer = __nccwpck_require__(6720);
...
exports = module.exports = __nccwpck_require__(1660);
exports.log = log;
...
exports.humanize = __nccwpck_require__(4817);
...
if (typeof process === 'undefined' || process.type === 'renderer') {
  module.exports = __nccwpck_require__(5338);
} else {
  module.exports = __nccwpck_require__(4158);
}
...
try {
  var supportsColor = __nccwpck_require__(9644);
...
var debug = __nccwpck_require__(3001)("follow-redirects");
...
const os = __nccwpck_require__(2037);
const hasFlag = __nccwpck_require__(6602);
...
const axios = __nccwpck_require__(7539);
const FormData = __nccwpck_require__(8795);
...
const uploadFile = __nccwpck_require__(6229);
